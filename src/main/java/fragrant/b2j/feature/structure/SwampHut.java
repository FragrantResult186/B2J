...
public class SwampHut extends BedrockFeatureGenerator {

    public static FeaturePos getSwampHut(BedrockFeatureConfig config, long worldSeed, int regX, int regZ) {
