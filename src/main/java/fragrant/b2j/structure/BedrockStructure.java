...
public class BedrockStructure {
    ...
    public static StructurePos isBedrockStructureChunk(int structureType, int version, long worldSeed, int chunkX, int chunkZ) {
        ...
        StructurePos structurePos = BedrockStructure.getBedrockStructurePos(structureType, version, worldSeed, regX, regZ, true);
    ...
    public static List<StructurePos> getBedrockStructuresRadius(List<Integer> structureTypes, int version, long worldSeed, int centerChunkX, int centerChunkZ, int radiusChunk, boolean skipBiomeCheck) {
        ...
        for (int structureType : structureTypes) {
            ...
            for (int regX = centerRegX - maxRegRadius; regX <= centerRegX + maxRegRadius; regX++) {
                for (int regZ = centerRegZ - maxRegRadius; regZ <= centerRegZ + maxRegRadius; regZ++) {
                    StructurePos pos = getBedrockStructurePos(structureType, version, worldSeed, regX, regZ, skipBiomeCheck);
