...
public class BedrockStructureConfig {
    ...
    public static BedrockStructureConfig getForType(int structureType, int version) {
        ...
        BedrockStructureConfig VILLAGE_STRONGHOLD = new BedrockStructureConfig(  97858791, 150, 200, BedrockStructureType.VILLAGE_STRONGHOLD, DIM_OVERWORLD, 0);
        BedrockStructureConfig STATIC_STRONGHOLD  = new BedrockStructureConfig(  97858791, 150, 200, BedrockStructureType.STATIC_STRONGHOLD,  DIM_OVERWORLD, 0);
        ...
        return switch (structureType) {
            ...
            case BedrockStructureType.VILLAGE_STRONGHOLD -> isAtLeast(version, MC_1_14)   ? VILLAGE_STRONGHOLD : null;
            case BedrockStructureType.STATIC_STRONGHOLD  -> isAtLeast(version, MC_1_14)   ? STATIC_STRONGHOLD : null;
