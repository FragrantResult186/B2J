...
public class JungleTemple extends BedrockFeatureGenerator {

    public static FeaturePos getJungleTemple(BedrockFeatureConfig config, long worldSeed, int regX, int regZ) {
