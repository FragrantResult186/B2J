package fragrant.biome.biome.surface;

import fragrant.biome.biome.surface.builder.SurfaceBuilder;
...
public class ConfiguredSurfaceBuilders {
    ...
    public static final SurfaceBuilder DEEP_DARK = register("deep_dark", SurfaceBuilders.DEFAULT.apply(SurfaceConfig.CONFIG_DEEP_DARK));
