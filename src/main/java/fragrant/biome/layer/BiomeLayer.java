...
import fragrant.biome.layer.land.BaseBiomesLayer;
import fragrant.biome.layer.land.ContinentLayer;
import fragrant.biome.layer.noise.NoiseLayer;
import fragrant.biome.layer.scale.ScaleLayer;
import fragrant.biome.layer.water.RiverLayer;
...
public abstract class BiomeLayer {
	 ...
	 *
	 * @param x the blockX coordinate
	 * @param y the y coordinate
	 * @param z the centerZ coordinate
