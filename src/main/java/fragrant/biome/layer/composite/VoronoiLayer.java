package fragrant.biome.layer.composite;

import fragrant.core.rand.seed.SeedMixer;
import fragrant.core.rand.seed.WorldSeed;
...
public class VoronoiLayer extends IntBiomeLayer {
	...
	public VoronoiLayer(MCVersion version, long worldSeed, boolean is3D, IntBiomeLayer parent) {
		super(version, worldSeed, version.isOlderThan(MCVersion.v1_16_0) ? 10L : 0L, parent);
		this.seed = version.isOlderThan(MCVersion.v1_16_0) ? worldSeed : WorldSeed.toHash(worldSeed);
		this.is3D = is3D;
	}
	...
	public int sample(int x, int y, int z) {
		return this.getVersion().isOlderThan(MCVersion.v1_16_0) ? this.sample14minus(x, z) : this.sample15plus(x, y, z);
	}
