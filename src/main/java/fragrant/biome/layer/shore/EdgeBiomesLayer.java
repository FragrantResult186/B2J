package fragrant.biome.layer.shore;
...
public class EdgeBiomesLayer extends CrossLayer {
	...
	public int sample(int n, int e, int s, int w, int center) {
		...
		if(this.getVersion().isOlderOrEqualTo(MCVersion.v1_0_0)) return center;
		if(this.getVersion().isOlderOrEqualTo(MCVersion.v1_6_2)) return sampleOld(n, e, s, w, center);
