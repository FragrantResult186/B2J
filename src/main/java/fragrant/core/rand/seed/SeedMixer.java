package fragrant.core.rand.seed;
...
public class SeedMixer {
	 ...
	 *  Given y, solve for blockX:
	 *                              ax^2 + bx = ay^2 + by mod 2^64
	 *                  ax^2 + bx - ay^2 + by = 0 mod 2^64
	 *      (ax^2 + bx - ay^2 + by) / (blockX - y) = 0 mod 2^64
	 *      ((blockX - y)(a(blockX + y) + b)) / (blockX - y) = 0 mod 2^64
	 *                           a(blockX + y) + b = 0 mod 2^64
	 *                                  blockX + y = -b * a' mod 2^64
	 *                                      blockX = -b * a' - y mod 2^64
     *
