...
public class RightTurn extends Stronghold.Piece { //Called SHRightTurn in bedrock
	...
	public RightTurn(int pieceId, ChunkRand rand, BlockBox boundingBox, BlockDirection facing) {
		super(pieceId);
	...
	public static RightTurn createPiece(List<Stronghold.Piece> pieces, ChunkRand rand, int x, int y, int z, BlockDirection facing, int pieceId) {
