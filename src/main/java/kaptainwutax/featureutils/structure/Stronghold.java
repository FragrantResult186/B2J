...
public class Stronghold extends Structure<Stronghold.Config, Stronghold.Data> {
	...
	public static abstract class Piece extends StructurePiece<Piece> {
		...
		protected Piece connectStraight(StrongholdGenerator gen, Start start, List<Piece> pieces, JRand rand, int int_1, int int_2) {
		...
		protected Piece connectLeft(StrongholdGenerator gen, Start start, List<Piece> pieces, JRand rand, int int_1, int int_2) {
			Direction facing = this.getFacing();
		...
		protected Piece connectRight(StrongholdGenerator gen, Start start, List<Piece> pieces, JRand rand, int int_1, int int_2) {
			Direction facing = this.getFacing();
